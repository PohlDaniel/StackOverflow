...
HRESULT WINAPI DXUTCreateWindow( const WCHAR* strWindowTitle = L"Direct3D Window", HWND hwnd = NULL,
...
HRESULT WINAPI DXUTCreateDevice(ID3D10Device *D3DDevice = NULL, IDXGISwapChain* swapChain = NULL, bool bWindowed = true, int nSuggestedWidth = 0, int nSuggestedHeight = 0 );
