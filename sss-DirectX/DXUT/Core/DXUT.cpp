...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTCreateWindow( const WCHAR* strWindowTitle, HWND hwnd, HINSTANCE hInstance,
...
//--------------------------------------------------------------------------------------
HRESULT WINAPI DXUTCreateDevice(ID3D10Device *D3DDevice, IDXGISwapChain* swapChain, bool bWindowed, int nSuggestedWidth, int nSuggestedHeight)
{
   
	GetDXUTState().SetD3D10SwapChain(swapChain);
	GetDXUTState().SetD3D10Device(D3DDevice);
    return S_OK;
}
